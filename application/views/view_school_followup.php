        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a class="btn btn-primary" href="<?php echo site_url('schoolinq/add_followup_data/'.$fo_id) ?>">Add Follow up</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
