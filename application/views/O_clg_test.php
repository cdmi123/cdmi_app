              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="course" class="form-control" id="exampleInputEmail1" placeholder="Enter Regno" value="<?php echo $student['college_course'];?>">
                  </div>
                  <div class="form-group">
