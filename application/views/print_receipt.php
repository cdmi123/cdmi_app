                    ...
                    <tr>
                      <td colspan="2">
                        <table class="table-borderless text-uppercase" width="100%">
                          ...
                          <tr>
                            <td colspan="2">                              
                                <h3 class="profile-username font-weight-bold">Course : <?php echo $info['course'];?> TUTION</h3>
                            </td> 
                            <td width="30%">
                          ...
                          <tr>
                            <td width="70%" colspan="2">
                              ...
                              <h3 class="profile-username font-weight-bold">
                               Payment By : <?php echo $info['pay_mode'];?> <?php if($info['pay_mode']!="CASH"){
                                      ?>
                            ...
                            <td width="30%">
                              <h3 class="profile-username font-weight-bold">Amount : <?php echo $info['amount'];?>/-</h3>
                            </td>
                          ...
                          <tr>
                            <td colspan="3" width="70%">
                              <h3 class="profile-username font-weight-bold">
                                Amount in Words : <?php echo getIndianCurrency($info['amount']).' ONLY';?>
                              </h3>
                            </td>                            
                          </tr>
                          <tr>
                            <td colspan="3">
                              <h3 class="profile-username font-weight-bold">Description : <?php echo $info['extra_detail'];?></h3>
                            </td>
                          </tr>
                          <tr>
                            <td>
