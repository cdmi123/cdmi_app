...
$route['api/student-info/(:any)'] = "ApiController/student_info/$1";
$route['api/view-student'] = "ApiController/view_stduent";
$route['api/all-batch'] = "ApiController/view_batches";
$route['api/view-batch/(:any)'] = "ApiController/single_batch/$1";
$route['api/faculty-batch/(:any)'] = "ApiController/faculty_batch/$1";
$route['api/student-attendence/(:any)'] = "ApiController/regular_attendence/$1";
$route['api/student-marks/(:any)'] = "ApiController/student_marks/$1";


/* Student App API */

$route['student-api/student'] = "Student/check_number";
$route['student-api/password'] = "Student/set_password";
$route['student-api/login'] = "Student/login";
$route['student-api/total_days'] = "Student/count_total_days";
$route['student-api/leave'] = "Student/get_total_leave";
$route['student-api/leave_remark'] = "Student/get_leave_remark";
$route['student-api/prsent'] = "Student/get_total_present";
$route['student-api/complain'] = "Student/get_total_complain";
$route['student-api/complain_report'] = "Student/get_complain";
$route['student-api/exam_report'] = "Student/get_exam_report";
