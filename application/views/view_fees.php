          ...
          <form method="post" id="search_form">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover table-font">
                ...
                {
                  $ac_info = $this->Fees_model->get_ac_info($info['ac_id']);
                ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('fees/index/update/'.$info['id']);?>" class="btn btn-primary btn-sm m-1"><i class="fas fa-edit"></i></a>
                    <a href="<?php echo site_url('fees/print_receipt/'.$info['id']);?>" class="btn btn-primary btn-sm m-1"><i class="fas fa-print"></i></a>
                  </td>
