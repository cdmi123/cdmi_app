            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover table-font">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('College_fees/index/update/'.$info['id'].'/certificate');?>" class="btn btn-primary btn-sm m-1"><i class="fas fa-edit"></i></a>
