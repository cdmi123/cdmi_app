      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-5">
                <a href="<?php echo site_url('view-uni-fees-payment')?>" class="btn btn-primary btn-block my-1"><i class="fas fa-list"></i> University Payment List</a>
              </div>
            </div>
