                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="role">
                        ...
                        <option value="9" <?php if(@$data1['role']==9){echo 'selected';}?>>Other</option>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Punching Code</label>
                    <input type="text" class="form-control" id="punchcode" name="punchcode" placeholder="Enter Punch code" value="<?php echo @$data1['punchcode'];?>">
                  </div>
                </div>
                <!-- /.card-body -->
