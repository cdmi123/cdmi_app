            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover table-font">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('college_fees/return_fees/update/'.$info['id']);?>" class="btn btn-primary btn-sm m-1"><i class="fas fa-edit"></i></a>
                  </td>
                </tr>
                <?php
                }
    ...
    $(document).on("click",'.pagination > a',function(e){
      ...
      //return false;
       ...
       $('.filter').change(function(){
        ...
        $.ajax({
          type:"POST",
          url:"<?php echo site_url('college_fees/return_fees_rec');?>",
          data:formData,
          dataType:"json",
          success:function(data){
            $('#example3').html(data.data);
