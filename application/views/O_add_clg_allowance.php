        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <div class="row">
              ...
              <div class="col-4">
                <a href="<?php echo site_url('admission/view_admission')?>" class="btn btn-primary btn-block my-1"><i class="fas fa-list"></i> View Allowance</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <form role="form" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label id="total_paid" style="width:50%">Total Paid Fees : 0</label>
                    <label id="allowance_paid">Allowance Paid : 0</label>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="pay_to" value="<?php echo @$up['pay_to']?>" class="form-control" id="pay_to" placeholder="Payee Name" >
                  </div>
                  <div class="form-group">
...
setTimeout(function(){
    ...
    $('#regno').blur(function(e){
      var regno = $('#regno').val();
        $.ajax({
          type:"POST",
          url:"<?php echo site_url('college_fees/ajax_get_student_details');?>",
          data:{regno:regno},
          dataType:"json",
