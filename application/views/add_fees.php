                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="gst" id="gst">
                          ...
                          <option value="COMP" <?php if(@$up['gst']=="COMP"){echo "selected";} ?>>Composition</option>
                          <option value="YES-IN" <?php if(@$up['gst']=="YES-IN"){echo "selected";} ?>>Inclusive</option>
                          <option value="YES-EX" <?php if(@$up['gst']=="YES-EX"){echo "selected";} ?>>Exclusive</option>
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="ac_id" required>
...
setTimeout(function(){
    ...
    $('#fees_amount').keyup(function(e){
      ...
      if($('#gst').val() == "YES-IN"){
        ...
        $('#tax_amount').val(gst_amount)
        $('#net_amt').val(net_amount)
      }else if($('#gst').val() == "COMP"){
        //var gst_amount = (amount-(amount*(100/(100+6)))).toFixed(2);
        //var net_amount = amount-gst_amount
        $('#tax_amount').val("0")
        $('#net_amt').val(amount)
      }
