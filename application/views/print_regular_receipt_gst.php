                      ...
                      <tbody>
                        <tr>
                          <td colspan="3" align="center" class="position-relative">
                            <p style="background-color:#fff;display: inline-block;border: 1px #aaa solid; padding: 8px 20px; margin: 5px 5px;  font-size: 24px;font-weight: bold;">Fees Receipt</p>
                              ...
                              <tr>
                                <td colspan="3"> 
                                  <table class="table amount_data mb-0" width="100%" style="font-size: 18px;">
                                    ...
                                    <tr>
                                      <td>GST(18%)</td>
                                      <td class="text-right pr-4" width="20%">₹ <?php echo number_format($info['tax_amount']);?>/-</td>
                                    </tr>
                                    <tr>
                                      <th>Net Payment</th>
                                      <th class="text-right pr-4" width="20%">₹ <?php echo number_format($net_amt);?>/-</th>
                                    </tr>
                                    <tr>
                                      <td colspan="2" >
